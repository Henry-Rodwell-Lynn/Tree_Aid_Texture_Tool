  ...
  return (
    ...
    >
      <motion.div
        ...
        className="divide-y-2 divide-[#335402] text-[#335402] w-full max-w-none border-t-2 border-l-2 border-b-2 border-r-2 border-[#335402]"
      >
        <div className="flex items-center gap-2">
          <div className="bg-[#335402] p-4">
            <img className="h-16" src="/assets/WHITE-LOGO.svg" />
          </div>
          <h1 className="text-3xl font-bold mb-3 mt-3 ml-3 text-[#335402]">
            Texture Generator:
          </h1>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="px-5 py-3 text-base font-bold focus:outline-none transition-colors duration-150 ease-in-out border-2 border-[#335402] hover:bg-[#D2F49E] hover:text-[#335402]"
            >
              Fade In
            </button>
            <button
                              ...
                              ${
                                activeColorSchemeName === scheme.name
                                  ...
                                  : "ring-1 ring-gray-400 " +
                                    (activeColorSchemeName !== scheme.name
                                      ? "hover:ring-gray-500 hover:bg-[#D2F49E] hover:text-[#335402]"
                                      : "") +
          ...
          <div className="grid gap-2">
            {availableTreeTypes.map((tree) => (
              <button
                ...
                className={`px-5 py-3 text-base font-bold focus:outline-none transition-colors duration-150 ease-in-out border-2 border-[#335402] ${
                  selectedTreeTypeId === tree.id
                    ? "bg-[#335402] text-[#D2F49E]"
                    : "bg-transparent text-[#335402]"
                } ${
                  selectedTreeTypeId !== tree.id
                    ? "hover:bg-[#D2F49E] hover:text-[#335402]"
                    : ""
                }`}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`px-5 py-3 text-base font-bold border-2 border-[#335402] transition-colors duration-150 ease-in-out ${
                isPaused
                  ? "bg-[#D2F49E] text-[#335402] animate-pulse"
                  : "bg-transparent text-[#335402]"
              } hover:bg-[#D2F49E] hover:text-[#335402] flex justify-center items-center`}
            >
            ...
            <button
              ...
              className="px-5 py-3 text-base font-bold focus:outline-none transition-colors duration-150 ease-in-out border-2 border-[#335402] hover:bg-[#D2F49E] hover:text-[#335402] flex justify-center items-center"
            >
              <div className="flex justify-center items-center w-full h-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex-col flex gap-2">
            ...
            <button
              ...
              style={{
                ...
                color: isRecording ? "white" : "#335402",
                cursor: "pointer",
              }}
            >
